...
class RegisterTriggerPort(ABC):
    ...
    async def update(self, trigger_id: UUID, updates: dict[str, Any]) -> TriggerDefinition:
        ...
        Returns:
            The updated :class:`~capillary_sdk.models.cycle_loop.TriggerDefinition`.
        """
        ...
    ...
    async def list_triggers(self, org_id: UUID) -> list[TriggerDefinition]:
        ...
        Returns:
            List of :class:`~capillary_sdk.models.cycle_loop.TriggerDefinition` instances.
        """
        ...
    ...
    async def get_trigger_history(self, trigger_id: UUID, limit: int) -> list[TriggerEvent]:
        ...
        Returns:
            List of :class:`~capillary_sdk.models.cycle_loop.TriggerEvent` instances.
        """
        ...
...
class RunOrchestratorPort(ABC):
    ...
    async def run(
        ...
        Yields:
            :class:`~capillary_sdk.models.cycle_loop.OrchestrationEvent` instances.
        """
        ...
    ...
    async def get_status(self, orchestration_run_id: UUID) -> OrchestrationStatus:
        ...
        Returns:
            :class:`~capillary_sdk.models.cycle_loop.OrchestrationStatus` snapshot.
        """
        ...
...
class RunAgentLoopPort(ABC):
    ...
    async def run(
        ...
        Yields:
            :class:`~capillary_sdk.models.cycle_loop.LoopEvent` instances.
        """
        ...
...
class WorkflowInvokerPort(ABC):
    ...
    async def invoke(
        ...
        Returns:
            :class:`~capillary_sdk.models.cycle_loop.WorkflowResult`.
        """
        ...
...
class LoopStatePort(ABC):
    ...
    async def get_iterations(self, loop_run_id: UUID) -> list[LoopIteration]:
        ...
        Returns:
            List of :class:`~capillary_sdk.models.cycle_loop.LoopIteration` instances.
        """
        ...
...
class OrchestrationStatePort(ABC):
    ...
    async def get_run(self, run_id: UUID) -> OrchestrationRun | None:
        ...
        Returns:
            The :class:`~capillary_sdk.models.cycle_loop.OrchestrationRun` or ``None``.
        """
        ...
    ...
    async def list_runs(
        ...
        Returns:
            List of :class:`~capillary_sdk.models.cycle_loop.OrchestrationRun` instances.
        """
        ...
